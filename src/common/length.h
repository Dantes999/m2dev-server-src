...
enum EMisc2
{
	...
	DRAGON_SOUL_EQUIP_SLOT_END = DRAGON_SOUL_EQUIP_SLOT_START + ((int)DS_SLOT_MAX * (int)DRAGON_SOUL_DECK_MAX_NUM),
	DRAGON_SOUL_EQUIP_RESERVED_SLOT_END = DRAGON_SOUL_EQUIP_SLOT_END + ((int)DS_SLOT_MAX * (int)DRAGON_SOUL_DECK_RESERVED_MAX_NUM),
